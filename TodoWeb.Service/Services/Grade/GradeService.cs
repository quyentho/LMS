...
namespace TodoWeb.Service.Services.Grade
{
    public class GradeService : IGradeService
    {
        ...
        public int PostGradeStudent(PostGradeViewModel gradeViewModel)
        {
            ...
            var courseStudentId = _courseStudentService.PostCourseStudent(new Application.Dtos.CourseStudentModel.PostCourseStudentViewModel
            {
            ...
            var data = new TodoWeb.Domains.Entities.Grade
            {
        ...
        public int PutGradeStudent(PostGradeViewModel gradeViewModel)
        {
            ...
            if(grade == null)
            {
                grade = new TodoWeb.Domains.Entities.Grade
                {
